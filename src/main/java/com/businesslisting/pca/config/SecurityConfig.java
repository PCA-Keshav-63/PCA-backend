...
@EnableMethodSecurity // This annotation enables method-level security, allowing you to use annotations like @PreAuthorize and @Secured
// It is useful for securing individual methods in your controllers or services based on roles or permissions.
